...
var rootCmd = &cobra.Command{
	Use:   "calc",
	Short: "A simple mathematical CLI that is capable of adding numbers",
	Long: `Calc is a simple CLI application capable of 2 jobs:
  - Adding any amount of numbers, or
  - Adding only even or only odd numbers`,
